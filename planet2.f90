...
module planet2
  ...
  double precision :: r_b		=  6251.8d3	       		! bottom of model		[m]
  double precision :: r_t		= 10000d3        	        ! top of model			[m]

  ! *** Planetary Parameters ***
  double precision, parameter :: r_planet	= 6051.8d3                ! planetary radius              [m]
  double precision, parameter :: m_planet	= 4.8675d24		! planetary mass                [kg]
