#!/usr/bin/env python3
"""
CONVERSION TEMPLATE - KEEP FOR REFERENCE

Script to convert O-N2 collision cross section files to the required 2-column CSV format.

This script should be retained as a template because:
1. Future O-N2 collision data may arrive in similar .dat format  
2. It provides the conversion logic for units (cm⁻¹ to eV, atomic units to cm²)
3. It can be adapted for new datasets with similar format
